...
// Play a music file  repeat(0) is no, -1 is yes
bool Audio::PlayMusic(const char* path, int repeat, float fadeTime)
{
	bool ret = true;
	...
	else
	{
		if (fadeTime > 0.0f)
		{
			if (Mix_FadeInMusic(music, repeat, (int)(fadeTime * 1000.0f)) < 0)
			{
